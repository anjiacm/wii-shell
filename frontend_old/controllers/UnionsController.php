...
use frontend\models\UnionsSearch;
use common\controllers\FrontendBaseController;
 ...
 */
class UnionsController extends FrontendBaseController
{
    ...
    {
        if (($model = Unions::findOne($id)) !== null) {
            return $model;
        } else {
